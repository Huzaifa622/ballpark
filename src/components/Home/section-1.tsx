...
export default function Section1() {
  return (
    <div className="flex justify-center relative items-center h-[100vh] bg-[#00083C]   w-full">
      <Particles
    ...
    />
      ...
      <div className="flex justify-center relative items-center h-[100vh]">
        <h1 className="text-3xl text-center flex justify-center text-[#ffffff] items-center uppercase w-[50%] mx-auto">
